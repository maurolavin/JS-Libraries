Swal.fire({
    title: 'Atencion!',
    text: 'Este conversor de unidades esta en desarrollo. Puede tener errores y problemas para funcionar.',
    confirmButtonText: 'Entiendo :)',
    confirmButtonColor: '#89b136',
...
function conversion(){
    ...
    Toastify({
        ...
        duration: 1500,
        className: "success",
        destination: "https://github.com/maurolavin",
        newWindow: true,
        gravity: "top",
        position: "center",
